...
print("Start")
with open("./result/sachs_llama3_8b.txt", mode="w+", encoding="UTF-8") as result_file:
    for i in range(len(examples)):
        messages = [
            ...
            {"role": "user", "content": f"你是一个专业的生物信息学研究者，请根据{examples[i]}，回答以下问题：{questions[i]}用中文回答且长度不超过300字。"},
