...
with open("./result/laws_preschool_education_llama3_8b.txt", mode="w+", encoding="UTF-8") as result_file:
    for i in range(len(questions)):
        ...
        messages = [
            ...
            {"role": "user", "content": f"你是一名中华人民共和国的儿童教育方面的法律专家，回答以下{questions[i]}并给出解释。用中文回答且长度不超过300字。"},
